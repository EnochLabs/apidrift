...
async function cmdList(flags = {}) {
    ...
    for (const snap of snapshots) {
        ...
        console.log(`  ${c.gray}  ${fieldCount} fields · seen ${snap.responseCount}x · last ${age} · ${driftLabel}${c.reset}`);
        console.log("");
    }
}
async function cmdDiff(url, flags) {
...
async function cmdTypes(output) {
